...
function Body() {
  return (
    <div>
      <main className={"container-fluid px-3 " + styles.showcase + " " +  styles.banner}>
        <div className="container">
          <h1>ft_transcendence.</h1>
          <p className="lead">
            {" "}
            In this subject you will need to build a website for the mighty pong
            contest. Your website will help user run pong tournament and play
            against each other. There will be an admin view, chat with
            moderators, real time multiplayer online games. There will be guilds
            and wars!
          </p>
          <p className="lead">
            <a
